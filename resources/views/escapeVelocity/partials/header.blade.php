<section id="header" class="wrapper">
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								<li>
									<a href="{{ action([App\Http\Controllers\FamiliasProfesionalesController::class, 'getIndex']) }}">Familias Profesionales</a>
									<ul>
								...
								<li>
									<a href="{{ action([App\Http\Controllers\CiclosFormativosController::class, 'getIndex']) }}">Ciclos Formativos</a>
									<ul>
								...
								<li>
									<a href="{{ action([App\Http\Controllers\ResultadosAprendizajeController::class, 'getIndex']) }}">Resultados Aprendizaje</a>
									<ul>
								...
								<li>
									<a href="{{ action([App\Http\Controllers\CriteriosEvaluacionController::class, 'getIndex']) }}">Criterios evaluacion</a>
									<ul>
