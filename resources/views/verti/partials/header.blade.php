        ...
        <div class="row">
            <div class="col-4 col-12-medium">
                ...
                <section class="box feature">
                    <a href="#" class="image featured"><img src="{{ asset('/verti/images/pic01.jpg') }}"
                            alt="" /></a>
                    <div class="inner">
                        <header>
            ...
            <div class="col-4 col-12-medium">
                ...
                <!-- Box -->
                <section class="box feature">
                    <a href="#" class="image featured"><img src="{{ asset('/verti/images/pic02.jpg') }}"
                            alt="" /></a>
                    <div class="inner">
                        <header>
            ...
            <div class="col-4 col-12-medium">
                ...
                <!-- Box -->
                <section class="box feature">
                    <a href="#" class="image featured"><img src="{{ asset('/verti/images/pic03.jpg') }}"
                            alt="" /></a>
                    <div class="inner">
                        <header>
