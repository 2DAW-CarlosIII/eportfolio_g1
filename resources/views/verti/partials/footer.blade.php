...
<script src="{{ asset('/verti/assets/js/jquery.min.js') }}"></script>
<script src="{{ asset('/verti/assets/js/jquery.dropotron.min.js') }}"></script>
<script src="{{ asset('/verti/assets/js/browser.min.js') }}"></script>
<script src="{{ asset('/verti/assets/js/breakpoints.min.js') }}"></script>
<script src="{{ asset('/verti/assets/js/util.js') }}"></script>
<script src="{{ asset('/verti/assets/js/main.js') }}"></script>
